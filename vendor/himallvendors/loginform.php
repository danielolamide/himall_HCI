...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      ...
      <h1>Himall | Login Here</h1>
    </div>

    <!-- Login Form -->
    <form class="form-signin"  action="login.php" method="POST">
      <input type="text"  class="fadeIn second" name="email" placeholder="Enter email">
    ...
    <div id="formFooter">
       <div id="login">
        <p class="register">New to Himall? <span><a href="signup.php" class="a">Create an account</a></span></p>
      </div>
    </div>
